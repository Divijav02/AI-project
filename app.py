...
pages = [
    ...
    st.Page("pages/06_Risk_Prediction.py",title="Risk Prediction",icon="🚦",url_path="/risk-prediction"),
    st.Page("pages/07_Weather_Violation_Recommendation.py",title="Weather Violation Recommendation",icon="🌦️",url_path="/Weather-Violation-Recommendation"),
